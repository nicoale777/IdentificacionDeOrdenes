...
import services.people.PeopleFilterInterface as filterInterface

class PeopleFilterImp(filterInterface.PeopleFilterInterface):
    ...
    def __init__(self):
        ...
        modelWeights='C:/Users/nicoa/OneDrive/Documentos/ReconocimientoDeOrdenes/yolo3/yolov3_320.weights'

        self.net= cv2.dnn.readNetFromDarknet(modelConf,modelWeights)
        self.net.setPreferableBackend(cv2.dnn.DNN_BACKEND_OPENCV)
        self.net.setPreferableTarget(cv2.dnn.DNN_TARGET_CPU)
        
    def detect_people(self,img)-> list:
